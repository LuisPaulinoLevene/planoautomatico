...
function gerarPlano() {
    ...
    if (escola && data && nome && disciplina && classe && turma && unidadeTematica && tema && objetivosText && tempo && duracao && tipoDeAula) {
        ...
        rows[1].cells[2].innerHTML = `<div class="left-align">- Explora os conhecimentos sobre o tema;<br>- Explica o conteudo;<br>- Levanta as dúvidas; <br>- Esclarece as dúvidas; <br>- Passa os apontamentos no quadro.</div>`;
        rows[1].cells[3].innerHTML = `<div class="left-align">- Contribui pelos conhecimentos sobre o tema;<br>- Presta atenção na explicação do conteudo;<br>- Apresenta as dúvidas; <br>- Presta atenção no esclarecimento das dúvidas; <br>- Passa os apontamentos no caderno.</div>`;
